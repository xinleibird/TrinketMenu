...
StopQueueHereTooltip =
	"Move this to mark the lowest trinket to auto queue.  Sometimes you may want a passive trinket with a click effect to be the end (Burst of Knowledge, Second Wind, etc)."
...
TrinketMenu.Message5 =
	"Note: You can drag the lower-right corner of either window to scale.  This slash command is for those who want to set an exact scale."
...
if GetLocale() == "zhCN" then
	TrinketMenu.CheckOptInfo = {
		...
		{ "ShowHotKeys", "ON", "显示快捷键", "在饰品上显示绑定的快捷键." },
		{
			...
			"OFF",
			"被动饰品停止排队",
			"当换上一个被动饰品时停止自动排队.  选中这个选项时, 当一个可点击饰品通过 TrinketMenu 被手动换上时同样会停止自动排队..",
		},
	}
	...
	TrinketMenu.TooltipInfo = {
		{
			...
			"上面饰品栏自动排队",
			"选中这个选项会让饰品自动排队替换到上面的饰品栏.  你也可以Alt+点击饰品来开关自动排队.",
		},
		{
			"TrinketMenu_Trinket1Check",
			"下面饰品栏自动排队",
			"选中这个选项会让饰品自动排队替换到下面的饰品栏.  你也可以Alt+点击饰品来开关自动排队.",
		},
		{
			"TrinketMenu_SortPriority",
			"高优先权",
			"当选中这个选项时, 这个饰品会被第一时间装备上, 而不管装备着的饰品是否在冷却中.\n\n当没选中时, 这个饰品不会替换掉没有在冷却中的已装备饰品.",
		},
		{
			"TrinketMenu_SortDelay",
			"延迟替换",
			"设置一个饰品被替换的时间 (秒).  比如, 你需要20秒得到大地之击的20秒BUFF.",
		},
		{
	...
	TrinketMenu.Tooltip2 =
		"左键点击: 开关饰物窗口\n右键点击: 开关选项窗口\n拖动: 移动设置按钮"
	StopQueueHereText1 = "-- 停止排队线 --"
	StopQueueHereText2 = "停止排队线"
	StopQueueHereTooltip =
		"移动这个来标记让下面的饰品不自动排队.  当你想让一个被动饰品只允许手动换上时, 就把它移动到这条线的下面."
