...
TrinketMenu.CheckOptInfo = {
	...
	{ "Notify", "OFF", "Notify When Ready", "Sends an overhead notification when a trinket's cooldown is complete." },
	{
		...
		"OFF",
		"Disable Toggle",
		"Disables the minimap button's ability to toggle the trinket frame.",
		"ShowIcon",
	},
	...
	{ "ShowTooltips", "ON", "Show Tooltips", "Shows tooltips." },
	{
		...
		"ON",
		"Notify At 30 sec",
		"Sends an overhead notification when a trinket has 30 seconds left on cooldown.",
	},
	...
	},
	{
		...
		"OFF",
		"Tiny Tooltips",
		"Shrink trinket tooltips to only their name, charges and cooldown.",
		"ShowTooltips",
	},
	{
		"SetColumns",
		"OFF",
		"Set Menu Columns",
		"Define how many trinkets before the menu will wrap to the next row.\n\nUncheck to let TrinketMenu choose how to wrap the menu.",
	},
	...
	{ "ShowHotKeys", "ON", "Show Key Bindings", "Display the key bindings over the equipped trinkets." },
	{
		...
		"OFF",
		"Stop Queue On Swap",
		"Swapping a passive trinket stops an auto queue.  Check this to also stop the auto queue when a clickable trinket is manually swapped in via TrinketMenu.  This will have the most use to those with frequent trinkets marked Priority.",
	},
}
...
TrinketMenu.TooltipInfo = {
	{
		...
		"Top Trinket Auto Queue",
		"Check this to enable auto queue for this trinket slot.  You can also Alt+Click the trinket slot to toggle Auto Queue.",
	},
	{
		"TrinketMenu_Trinket1Check",
		"Bottom Trinket Auto Queue",
		"Check this to enable auto queue for this trinket slot.  You can also Alt+Click the trinket slot to toggle Auto Queue.",
	},
	{
		"TrinketMenu_SortPriority",
		"High Priority",
		"When checked, this trinket will be swapped in as soon as possible, whether the equipped trinket is on cooldown or not.\n\nWhen unchecked, this trinket will not equip over one already worn that's not on cooldown.",
	},
	{
		"TrinketMenu_SortDelay",
		"Swap Delay",
		"This is the time (in seconds) before a trinket will be swapped out.  ie, for Earthstrike you want 20 seconds to get the full 20 second effect of the buff.",
	},
	{
...
function TrinketMenu.InitOptions()
	...
	for i = 1, table.getn(TrinketMenu.CheckOptInfo) do
		...
		getglobal("TrinketMenu_Opt" .. TrinketMenu.CheckOptInfo[i][1] .. "Text"):SetTextColor(0.95, 0.95, 0.95)
	end
	...
	TrinketMenu_OptFrame:SetBackdropBorderColor(0.3, 0.3, 0.3, 1)
	TrinketMenu_SubOptFrame:SetBackdropBorderColor(0.3, 0.3, 0.3, 1)
	...
	for i = 1, table.getn(TrinketMenu.CheckOptInfo) do
		...
		if check[5] then
			if TrinketMenuOptions[check[5]] == "ON" then
				...
				getglobal("TrinketMenu_Opt" .. check[1] .. "Text"):SetTextColor(0.95, 0.95, 0.95)
			else
				getglobal("TrinketMenu_Opt" .. check[1]):Disable()
				getglobal("TrinketMenu_Opt" .. check[1] .. "Text"):SetTextColor(0.5, 0.5, 0.5)
			end
		end
	end
	TrinketMenu_OptColumnsSlider:SetAlpha((TrinketMenuOptions.SetColumns == "ON") and 1 or 0.5)
...
function TrinketMenu.ReflectLock()
	local c = TrinketMenuOptions.Locked == "ON" and 0 or 0.5
